    ...
    B. Set the path by doing one of the following:
        ...
        * Add the MCR directory to the environment variable by issuing 
        ...
        NOTE: When deploying C and C++ standalone applications, it is 
              possible to run the shell script file run_viterbi.sh 
...
3. Collect the following files, based on what you are deploying: 
    ...
    All Platforms:
        * viterbi.ctf (If present)(Component Technology File archive,
          platform-dependent on target machine)

    Windows:
        * MCRInstaller.exe (self-extracting MATLAB Compiler Runtime
          installer)
        * viterbi.exe (application created by MATLAB Compiler)

    UNIX:
        * MCRInstaller.bin (MATLAB Compiler Runtime installer)
        * viterbi (application created by MATLAB Compiler)
        * run_viterbi.sh (shell script that can be run to 
    ...
    All Platforms:
        * viterbi.dll (shared library, file extension varies by 
          platform)
        * viterbi.h (library header file)
        * viterbi.ctf (If present)(Component Technology File archive,
    ...
    Windows:
        * viterbi.ctf (Component Technology File archive, contains 
          compiled M-code)    
        * viterbi.xml (documentation files)
        * viterbi.pdb (program database file - if DEBUG option 
          selected)
        * viterbi.dll (component assembly file)
        * MCRInstaller.exe (self-extracting MATLAB Compiler Runtime
          archive)
    ...
    All Platforms: 
        * viterbi.jar (Java class files and compiled M-code)
    ...
    Windows:
        ...
        * viterbi.ctf (Component Technology File archive, contains 
          compiled M-code)
        * viterbi.xla (Optionally created and placed in
